<div>
    <div class="mx-auto px-3 md:w-2/3" x-data="{ discussion: false, musique: false, cigarette: false }">
        ...
        <h2 class="text-center text-xl md:text-3xl font-bold text-blue-600 mt-4 mb-8">
            Ajout d'une voiture
        </h2>

        <div class="flex flex-col hover:bg-gray-700 p-4 px-4 py-2 cursor-pointer mb-4" type="button"
            x-on:click="discussion = true" wire:click="edit">
            <h3 class="text-md text-gray-400 font-semibold">Marque</h3>
            <h3 class="text-lg text-blue-400 font-bold">
                @if ($marque)
                    {{ $marque }}
                @else
                    Pas de préférences
        ...
        {{-- <div x-show="discussion" x-on:keydown.escape.window="discussion = false" x-show.delay.500ms="discussion"
            ...
            <div class="relative bg-white rounded-lg  dark:bg-gray-700 ">
                ...
                <div class="py-6 px-6 lg:px-8 ">
                    ...
                    <div class="space-y-6">
                        <div>
                            <div type="button" class="flex justify-between mb-2  hover:bg-gray-100   p-6">
                                <label for="radio1"
