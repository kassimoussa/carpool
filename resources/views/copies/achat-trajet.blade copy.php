<div>
    ...
    <div class="flex justify-between items-center py-6 border-t-4  border-gray-500">
        <h3 class="text-xl italic text-white">
            Le trajet
        </h3>
        <div class="flex">
            <h3 class="pr-6 text-xl font-semibold text-white"> {{ $trip['ville_depart'] }} </h3>
            <svg aria-hidden="true" class="w-8 h-8 text-white font-semibold  " fill="currentColor"
            ...
            <h3 class="pl-6 text-xl font-semibold text-white"> {{ $trip['ville_destination'] }}
    ...
    <div class="flex py-6 justify-between items-center border-t-4 border-b-4  border-gray-500 ">
        <h3 class="text-xl italic text-white">
            <span class=""> Prix total pour {{ $trip['passagers'] }}</span>
        </h3>
        <h3 class="pl-6 text-xl font-semibold text-white">
    ...
    <div class=" border-b-4 border-gray-500 mb-4">
        <div class="flex justify-between py-4 items-center ">
            <div class="flex flex-col">
                <h3 class="text-md italic text-white">
                    Le conducteur
                </h3>
        ...
        <h3 class="text-md italic text-white mt-4">
        ...
        @if ($prefs)
            @if ($prefs->discussion)
                <div class="flex   py-3">
                    ...
                    <h3 class="pl-3 text-md text-white"> {{ $prefs->discussion }} </h3>
                </div>
            @endif
            ...
            @if ($prefs->musique)
                <div class="flex   py-3">
                    ...
                    <h3 class="pl-3 text-md text-white"> {{ $prefs->musique }} </h3>
                </div>
            @endif
            ...
            @if ($prefs->cigarette)
                <div class="flex   py-3 mb-4">
                    ...
                    <h3 class="pl-3 text-md text-white"> {{ $prefs->cigarette }} </h3>
                </div>
            @endif
        @else
            <div class="flex   py-3">
                <h3 class="pl-3 text-md text-white"> Aucune préférence indiquée </h3>
            </div>
        @endif
    ...
    <div class="border-b-4 border-gray-500 mb-4">
        ...
        @else
            <div class="flex   py-3">
                <h3 class="pl-3 text-md text-white"> Aucune voiture enrégistrée </h3>
            </div>
        @endif
    </div>
