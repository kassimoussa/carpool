@extends('layouts.app', ['title' => "S'inscrire sur COVO "])
@section('content') 
@if ($message = Session::get('success'))
    ...
    <div class="container mx-auto px-4 pt-2 ">
        ...
        <div class="mx-auto md:w-3/4 pt-4">

            <div class="title mb-10">
                <h1 class=" tracking-wider text-center text-xl md:text-3xl font-bold ">Inscription </h1>
            </div>
